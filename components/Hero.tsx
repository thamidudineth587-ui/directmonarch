...
export default function Hero() {
  ...
  return (
    <section ref={ref} id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <motion.div 
        className="absolute inset-0 bg-gradient-to-br from-primary-50 via-blue-50 to-white"
        style={{ y: backgroundY }}
      />
      ...
      >
        ...
        <motion.h1 
          className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-primary-900 to-primary-600 bg-clip-text text-transparent mb-6"
        ...
        >
          <motion.a 
            href="#contact" 
            className="group bg-primary-600 text-white px-8 py-4 rounded-lg hover:bg-primary-700 transition-all flex items-center text-lg font-medium shadow-lg hover:shadow-xl"
          ...
          <motion.a 
            href="#services" 
            className="group bg-white text-primary-600 px-8 py-4 rounded-lg border-2 border-primary-600 hover:bg-primary-50 transition-all flex items-center text-lg font-medium"
